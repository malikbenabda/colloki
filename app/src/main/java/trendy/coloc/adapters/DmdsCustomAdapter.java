    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.btnEdit.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(context, UpdateDemmande.class);
