...
import trendy.coloc.entities.DmdColoc;
import trendy.coloc.tools.Critera;
import trendy.coloc.tools.SaveSharedPreference;
import trendy.coloc.tools.SaveSharedPreferenceForDemande;

public class UpdateDemmande extends AppCompatActivity {
    ...
    String ch1 = "", ch2 = "", ch3 = "", ch4 = "", ch_custom = "";
    ...
    Date d1_converted, d2_converted, date_demande;
    ...
    Critera cr1, cr2, cr3, cr4;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_update_demmande);

        et_nbr_chambres = (EditText) findViewById(R.id.et_nbchambres_dmd);
        et_nbr_colocs = (EditText) findViewById(R.id.et_nbcolocs_dmd);
        et_pmin = (EditText) findViewById(R.id.et_pmin_dmd);
        et_pmax = (EditText) findViewById(R.id.et_pmax_dmd);
        et_titre = (EditText) findViewById(R.id.et_titre_u);

        spVille = (Spinner) findViewById(R.id.spinner_vl);
        benvoyer = (Button) findViewById(R.id.btndmd_dmd);


        rb_ville = (RadioButton) findViewById(R.id.villa_rb_dmd);
        rb_rpart = (RadioButton) findViewById(R.id.apart_rb_dmd);


        rb_fille = (RadioButton) findViewById(R.id.filles_rb_dmd);
        rb_gars = (RadioButton) findViewById(R.id.gars_rb_dmd);
        rb_mixte = (RadioButton) findViewById(R.id.mixte_rb_dmd);
        ...
        userId = SaveSharedPreference.getUserId(UpdateDemmande.this);

        final String IdAnnonce = SaveSharedPreferenceForDemande.getDemmandeId(UpdateDemmande.this);

        //Toast.makeText(getApplicationContext(),"demmande id: "+ch, Toast.LENGTH_SHORT).show();


        dateView = (TextView) findViewById(R.id.dte_dmd);
        dateView2 = (TextView) findViewById(R.id.dateText2_dmd);
...
////////////////////////////input check:
                ...
                if (!IsFieldEmpty(ch_ville) && !IsFieldEmpty(ch_nbr_chbrs) && !IsFieldEmpty(ch_nbr_clocs) &&
                        !IsFieldEmpty(ch_pmax) && !IsFieldEmpty(ch_pmin)) {
...
//////////////////////////Convert dates:
                        ...
                        dc = dc.UpdateDdmd(IdAnnonce, ch_titre, ch_ville, ch_json_final, d1_converted, d2_converted, date_demande);
...
//////////////////////////////////////prevent multiple clicks on submit button
                    ...
                    new Thread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            UpdateDemmande.this.runOnUiThread(new Runnable() {
...
//////////////////////////unfctions for date picking:
    ...
    public void DialogOtherCrs() {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(UpdateDemmande.this);
